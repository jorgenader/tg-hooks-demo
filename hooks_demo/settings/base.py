"""
Django settings for Hooks Demo project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Hooks Demo] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'hooks_demo_ssid'
...
DATABASES = {
    'default': {
        ...
        'NAME': env.str('DJANGO_DATABASE_NAME', default='hooks_demo'),
        'USER': env.str('DJANGO_DATABASE_USER', default='hooks_demo'),
        'PASSWORD': env.str('DJANGO_DATABASE_PASSWORD', default='hooks_demo'),
    }
}
...
ROOT_URLCONF = 'hooks_demo.urls'

WSGI_APPLICATION = 'hooks_demo.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "Hooks Demo <info@TODO.com>"
SERVER_EMAIL = "Hooks Demo server <server@TODO.com>"
