...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['office.hooks-demo.test.TODO.com', 'hooks-demo.test.TODO.com'])

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str('RAZZLE_SITE_URL', default='https://hooks-demo.test.TODO.com')
DJANGO_SITE_URL = env.str('RAZZLE_DJANGO_SITE_URL', default='https://office.hooks-demo.test.TODO.com')

CSRF_COOKIE_DOMAIN = env.str('DJANGO_CSRF_COOKIE_DOMAIN', default='.hooks-demo.test.TODO.com')
...
if env.str('DJANGO_DISABLE_FILE_LOGGING') != 'y':
    LOGGING['handlers'] = {
        'info_log': {
            ...
            'filename': '/var/log/hooks_demo/info.log',
            'formatter': 'default',
        },
        'error_log': {
            'level': 'ERROR',
            'class': 'logging.handlers.WatchedFileHandler',
            'filename': '/var/log/hooks_demo/error.log',
            'formatter': 'default',
        },
        'sentry': {
            'level': 'ERROR',
